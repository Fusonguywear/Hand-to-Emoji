...
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/BjvA5DRs3/model.json',modelLoaded);
...
function gotResult(error, results) {
    if (error) {
        ...
        speak();
        if(results[0].label == "oke")
        {
            document.getElementById("update_emoji").innerHTML = "&#128077";
        }
        if(results[0].label == "peas")
        {
